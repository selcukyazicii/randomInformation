...
namespace DataAccess.Concrete.EntityFramework
{
    public class InformationContext : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("server=DESKTOP-D5IEUUD\\MSSQLSERVER2022;database=bidijital_media;integrated security=true;");
        }

        public DbSet<Truth> Games { get; set; }
        public DbSet<Dare> Games2 { get; set; }
        public DbSet<bidijital_contact> Contacts { get; set; }
        public DbSet<bidijital_about_us> AboutUs { get; set; }
        public DbSet<bidijital_about> About { get; set; }
    }
}
